...
Scene1::Scene1()
{
	...
	pTextures->LoadTextureAnisotropic(0, "Scenes/tde/Scene1/Exer3/grama.bmp");
	pTextures->LoadTextureAnisotropic(1, "Scenes/tde/Scene1/Exer3/CRATE.BMP");
	pTextures->LoadTextureClamp(2, "Scenes/tde/Scene1/Exer3/House.jpg");
...
void Scene1::DestroyFloor()
{
	glDeleteVertexArrays(1, &floorVAO);
	glDeleteBuffers(1, &floorVBO);
}

void Scene1::DrawFloor()
{
	glBindVertexArray(floorVAO);
